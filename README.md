# Calculadora
Este projeto implementa uma calculadora simples em Python, capaz de realizar as quatro operações básicas (adição, subtração, multiplicação e divisão) com suporte a números decimais usando ponto ou vírgula.
...
Agora, para rodar a calculadora, digite:

./executar_calculadorapython.sh
